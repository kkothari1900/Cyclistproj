...
```{r}
# Bar plots: 
barplot(table(annual_mem$start_month),main = "Annual Members Number of Use By Month",xlab = "Month",ylab = "Count",border = "black",names.arg = c("Jan","Feb","Mar"),col = "blue",density = 50000)

barplot(table(casual_mem$start_month),main = "Casual Cyclist Users Number of Use By Month",xlab = "Month",ylab = "Count",names.arg = c("Jan","Feb","Mar"),border = "black",col = "red",density = 50000)
