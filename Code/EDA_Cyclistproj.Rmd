...
barplot(table(annual_mem$start_month),main = "Annual Members Number of Use By Month",xlab = "Month",ylab = "Number of Cyclist Trips ",border = "black",names.arg = c("Jan","Feb","Mar"),col = "blue",density = 50000)
dev.off()
